...
function LimitaTesto(campo){
var max; //Numero di caratteri max
max = 150;
if (campo.value.length > max-1) 
...
return false;
  ...
  ?>
    ...
    <div align=center> 
      <form ENCTYPE="multipart/form-data" method="post" action="add_ticker.php">
      <b>Aggiungi Ticker</b><br><br>
      Testo da caricare (max 150 caratteri)<br>
      <textarea name="contenuto" rows="4" cols="40" onKeyPress="LimitaTesto(this)"></textarea><br> 
      Titolo<br>
      ...
      <input type=submit name="carica" value="Carica">  <br><br>
      </form>
    </div>  
