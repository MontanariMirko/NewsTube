...
//URL da agganciare
$url_feed = "http://it.wikipedia.org/w/api.php?action=query&prop=revisions&titles=morti_il_".$gg."_".$mm."&rvprop=content&format=xml";
...
$stringa = strstr($stringa, "{{MultiCol}}");                                       
$stringa = str_replace("{{MultiCol}}", "== Morti del giorno ==", $stringa); 
$posizione = strpos($stringa, "{{EndMultiCol}}");
...
echo "<marquee align=middle scrollamount=1 height=$h vspace=20 width=$w direction=up scrolldelay=1 border=2><h$dim><b>$str</b></h$dim></marquee>"; 
?>
