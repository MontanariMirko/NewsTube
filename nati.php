...
//URL da agganciare
$url_feed = "http://it.wikipedia.org/w/api.php?action=query&prop=revisions&titles=nati_il_".$gg."_".$mm."&rvprop=content&format=xml";
...
$stringa = str_replace("{{MultiCol}}", "== Nati del giorno ==", $stringa); 
