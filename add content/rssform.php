...
<!-- Begin Content Form -->
     <table class='edit_win' cellpadding='6' cellspacing='0'>
       <tr>
         <td><h5><?= $rssform1_1; ?></h5><p><?= $rssform1_2; ?></p></td>
         <td colspan="2" class='edit_col'>
           <input type="text" class="extended" name="content[name]" value="<?=$content->name?>" />
         </td>
       </tr>
       <tr>
         <td><h5><?= $rssform1_3; ?></h5><p><?= $rssform1_4; ?></p></td>
         <td>
           <input type="text" class="start_date" name="content[start_date]" value="<?=$content->start_time?>" />
           <p class="start_time_msg"><?= $rssform1_5; ?> (00:00am)</p>
         </td>
         <td width="30%" style="text-align:right;"><a class="click_start_time" href="#"><?= $rssform1_6; ?></a>
           <div class="start_time_select" style="text-align:right;display:none"><?= $rssform1_7; ?>:
...
?>
       ...
       <tr>
         <td><h5><?= $rssform1_8; ?></h5><p><?= $rssform1_9; ?></p></td>
         <td>
           <input type="text" class="end_date" name="content[end_date]" value="<?=$content->end_time?>" />
           <p class="end_time_msg"><?= $rssform1_10; ?></p>
         </td>
         <td width="30%" style="text-align:right;"><a class="click_end_time" href="#"><?= $rssform1_11; ?></a>
           <div class="end_time_select" style="text-align:right;display:none"><?= $rssform1_12; ?>
...
?>
       ...
       <tr>
         <td><h5><?= $rssform1_13; ?></h5><p><?= $rssform1_14; ?></p></td>
         <td>
           <div class="duration_msg"><?= $rssform1_15; ?>3600<?= $rssform1_16; ?> (<?= $rssform1_23; ?>)</div>
           <div class="duration_div" style="display:none"><input type="text" size="2" name="content[duration]" value="<?= $content->duration?$content->end_time:3600?>" /> <?= $rssform1_16; ?></div>
         </td>
         <td width="30%" style="text-align:right;"><a class="click_duration" href="#"><?= $rssform1_17; ?></a>
         </td>
       </tr>
     </table>
     <!--<br /><br />
     ...
     <table class='edit_win' cellpadding='6' cellspacing='0'>
       <tr>
         <td>
           <div style="float:right;"><a class="click_add_feed" href="#"><?= $rssform1_18; ?></a></div>
           <h5><?= $rssform1_19; ?></h5>
           <p><b><?= $rssform1_20; ?></b></p>
           <br/>
           <div class="feeddiv">
...
?>
                 <option class="feedopt"
                   title="<?= $rssform1_21; ?><?=$scrcnt?><?= $rssform1_22; ?>" 
