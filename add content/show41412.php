...
<a href="<?=ADMIN_URL.'/content/remove/'.$this->content->id ?>"><span class="buttonsel"><div class="buttonleft"><img src="<?= ADMIN_BASE_URL ?>/images/buttonsel_left.gif" border="0" alt="" /></div><div class="buttonmid"><div class="buttonmid_padding">Cancella contenuto</div></div><div class="buttonright"><img src="<?= ADMIN_BASE_URL ?>/images/buttonsel_right.gif" border="0" alt="" /></div></span></a><div style="clear:both;height:12px;"></div>
<?php } ?>
</p>
<?php
...
<h3>Tempo attivit&agrave;: <span class="emph"><?=date("m/j/Y H:i",strtotime($this->content->start_time))?> - <?=date("m/j/Y H:i",strtotime($this->content->end_time))?></span></h3>

<h3>Inviato da: <span class="emph"><a href="<?=ADMIN_URL.'/users/show/'.$this->submitter->username?>"><?=$this->submitter->name?></a></span></h3>
